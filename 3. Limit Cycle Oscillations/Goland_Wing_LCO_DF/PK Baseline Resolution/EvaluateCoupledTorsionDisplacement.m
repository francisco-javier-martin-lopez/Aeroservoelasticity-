...
for k=1:length(y)
    ...
    NIDs=Connect(EID,5:7); %ID's of the nodes relevant to this element, in the ordering I've followed so far. 
    ...
    w(k)=[psi1,psi2,psi3]*q(NIDs); %to account for the change of variables we did in the rotational dofs.
end
end